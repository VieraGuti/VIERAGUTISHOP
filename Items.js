const items = {
    ...
    weapons: [
        ...
        { id: 'weapon.mod.small.scope', name: 'Scope x4', image: 'images/weapons/weapon.mod.small.scope.png' },
...
tools: [
    ...
    { id: 'hammer', name: 'Hammer', image: 'images/tools/hammer.png' },
    { id: 'fishingrod.handmade', name: 'Handmade Fishing Rod', image: 'images/tools/fishingrod.handmade.png' },
    { id: 'hatchet', name: 'Hatchet', image: 'images/tools/hatchet.png' },
    { id: 'jackhammer', name: 'Jackhammer', image: 'images/tools/jackhammer.png' },
    { id: 'pickaxe', name: 'Pickaxe', image: 'images/tools/pickaxe.png' },
    { id: 'pipetool', name: 'Pipe Tool', image: 'images/tools/pipetool.png' },
    { id: 'rf.detonator', name: 'RF Transmitter', image: 'images/tools/rf.detonator.png' },
    { id: 'rock', name: 'Rock', image: 'images/tools/rock.png' },
    { id: 'axe.salvaged', name: 'Salvaged Axe', image: 'images/tools/axe.salvaged.png' },
    { id: 'hammer.salvaged', name: 'Salvaged Hammer', image: 'images/tools/hammer.salvaged.png' },
    { id: 'icepick.salvaged', name: 'Salvaged Icepick', image: 'images/tools/icepick.salvaged.png' },
    { id: 'explosive.satchel', name: 'Satchel Charge', image: 'images/tools/explosive.satchel.png' },
    { id: 'grenade.smoke', name: 'Smoke Grenade', image: 'images/tools/grenade.smoke.png' },
    { id: 'spraycan', name: 'Spray Can', image: 'images/tools/spraycan.png' },
    { id: 'stonehatchet', name: 'Stone Hatchet', image: 'images/tools/stonehatchet.png' },
    { id: 'stone.pickaxe', name: 'Stone Pickaxe', image: 'images/tools/stone.pickaxe.png' },
    { id: 'supply.signal', name: 'Supply Signal', image: 'images/tools/supply.signal.png' },
    { id: 'torch', name: 'Torch', image: 'images/tools/torch.png' },
    { id: 'bucket.water', name: 'Water Bucket', image: 'images/tools/bucket.water.png' }
],
medsAndTeas: [
    { id: 'antiradpills', name: 'Anti-Radiation Pills', image: 'images/medsAndTeas/antiradpills.png' },
    { id: 'blueberries', name: 'Blueberries', image: 'images/medsAndTeas/blueberries.png' },
    { id: 'pumpkin', name: 'Pumpkin', image: 'images/medsAndTeas/pumpkin.png' },
    { id: 'bandage', name: 'Bandage', image: 'images/medsAndTeas/bandage.png' },
    { id: 'largemedkit', name: 'Large Medkit', image: 'images/medsAndTeas/largemedkit.png' },
    { id: 'syringe.medical', name: 'Medical Syringe', image: 'images/medsAndTeas/syringe.medical.png' },
    { id: 'radiationresisttea.advanced', name: 'Advanced Anti-Rad Tea', image: 'images/medsAndTeas/radiationresisttea.advanced.png' },
    { id: 'healingtea.advanced', name: 'Advanced Healing Tea', image: 'images/medsAndTeas/healingtea.advanced.png' },
    { id: 'maxhealthtea.advanced', name: 'Advanced Max Health Tea', image: 'images/medsAndTeas/maxhealthtea.advanced.png' },
    { id: 'oretea.advanced', name: 'Advanced Ore Tea', image: 'images/medsAndTeas/oretea.advanced.png' },
    { id: 'radiationremovetea.advanced', name: 'Advanced Rad. Removal Tea', image: 'images/medsAndTeas/radiationremovetea.advanced.png' },
    { id: 'scraptea.advanced', name: 'Advanced Scrap Tea', image: 'images/medsAndTeas/scraptea.advanced.png' },
    { id: 'woodtea.advanced', name: 'Advanced Wood Tea', image: 'images/medsAndTeas/woodtea.advanced.png' },
    { id: 'radiationresisttea', name: 'Anti-Rad Tea', image: 'images/medsAndTeas/radiationresisttea.png' },
    { id: 'healingtea', name: 'Basic Healing Tea', image: 'images/medsAndTeas/healingtea.png' },
    { id: 'maxhealthtea', name: 'Basic Max Health Tea', image: 'images/medsAndTeas/maxhealthtea.png' },
    { id: 'oretea', name: 'Basic Ore Tea', image: 'images/medsAndTeas/oretea.png' },
    { id: 'scraptea', name: 'Basic Scrap Tea', image: 'images/medsAndTeas/scraptea.png' },
    { id: 'woodtea', name: 'Basic Wood Tea', image: 'images/medsAndTeas/woodtea.png' },
    { id: 'radiationresisttea.pure', name: 'Pure Anti-Rad Tea', image: 'images/medsAndTeas/radiationresisttea.pure.png' },
    { id: 'healingtea.pure', name: 'Pure Healing Tea', image: 'images/medsAndTeas/healingtea.pure.png' },
    { id: 'maxhealthtea.pure', name: 'Pure Max Health Tea', image: 'images/medsAndTeas/maxhealthtea.pure.png' },
    { id: 'oretea.pure', name: 'Pure Ore Tea', image: 'images/medsAndTeas/oretea.pure.png' },
    { id: 'radiationremovetea.pure', name: 'Pure Rad. Removal Tea', image: 'images/medsAndTeas/radiationremovetea.pure.png' },
    { id: 'scraptea.pure', name: 'Pure Scrap Tea', image: 'images/medsAndTeas/scraptea.pure.png' },
    { id: 'woodtea.pure', name: 'Pure Wood Tea', image: 'images/medsAndTeas/woodtea.pure.png' },
    { id: 'radiationremovetea', name: 'Rad. Removal Tea', image: 'images/medsAndTeas/radiationremovetea.png' }
],
    trapsAndMiscellaneous: [
    { id: 'flameturret', name: 'Flame Turret', image: 'images/trapsAndMiscellaneous/flameturret.png' },
    { id: 'trap.landmine', name: 'Landmine', image: 'images/trapsAndMiscellaneous/trap.landmine.png' },
    { id: 'guntrap', name: 'Shotgun Trap', image: 'images/trapsAndMiscellaneous/guntrap.png' },
    { id: 'trap.bear', name: 'Snap Trap', image: 'images/trapsAndMiscellaneous/trap.bear.png' },
    { id: 'spikes.floor', name: 'Wooden Floor Spikes', image: 'images/trapsAndMiscellaneous/spikes.floor.png' },    
    { id: 'keycard_blue', name: 'Blue Keycard', image: 'images/trapsAndMiscellaneous/keycard_blue.png' },
    { id: 'door.key', name: 'Door Key', image: 'images/trapsAndMiscellaneous/door.key.png' },
    { id: 'keycard_green', name: 'Green Keycard', image: 'images/trapsAndMiscellaneous/keycard_green.png' },
    { id: 'fun.guitar', name: 'Guitar', image: 'images/trapsAndMiscellaneous/fun.guitar.png' },
    { id: 'note', name: 'Note', image: 'images/trapsAndMiscellaneous/note.png' },
    { id: 'keycard_red', name: 'Red Keycard', image: 'images/trapsAndMiscellaneous/keycard_red.png' }
],
components: [
    { id: 'fuse', name: 'Electric Fuse', image: 'images/components/fuse.png' },
    { id: 'propanetank', name: 'Empty Propane Tank', image: 'images/components/propanetank.png' },
    { id: 'gears', name: 'Gears', image: 'images/components/gears.png' },
    { id: 'metalblade', name: 'Metal Blade', image: 'images/components/metalblade.png' },
    { id: 'metalpipe', name: 'Metal Pipe', image: 'images/components/metalpipe.png' },
    { id: 'metalspring', name: 'Metal Spring', image: 'images/components/metalspring.png' },
    { id: 'riflebody', name: 'Rifle Body', image: 'images/components/riflebody.png' },
    { id: 'roadsigns', name: 'Road Signs', image: 'images/components/roadsigns.png' },
    { id: 'rope', name: 'Rope', image: 'images/components/rope.png' },
    { id: 'semibody', name: 'Semi Automatic Body', image: 'images/components/semibody.png' },
    { id: 'sewingkit', name: 'Sewing Kit', image: 'images/components/sewingkit.png' },
    { id: 'sheetmetal', name: 'Sheet Metal', image: 'images/components/sheetmetal.png' },
    { id: 'smgbody', name: 'SMG Body', image: 'images/components/smgbody.png' },
    { id: 'tarp', name: 'Tarp', image: 'images/components/tarp.png' },
    { id: 'techparts', name: 'Tech Trash', image: 'images/components/techparts.png' }
],
electrical: [
